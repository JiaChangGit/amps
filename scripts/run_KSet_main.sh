...
BUILD_DIR="./build"
#############
TEST_KSET_MAIN_EXEC="$BUILD_DIR/tests/KSet_main"
#############
...
"$TEST_KSET_MAIN_EXEC" -r "$RULESET_PATH" -e "$TRACE_PATH" -c 1

echo "Running upd tests..."
"$TEST_KSET_MAIN_EXEC" -r "$RULESET_PATH" -e "$TRACE_PATH" -c 0 -u 1
